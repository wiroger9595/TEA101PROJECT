...
public class SpaceVO {
	...
	public static class Builder {
		...
		private Double avgComment = 0.0;
		
		private Double detailCharge = 0.0;
	...
	public Double getDetailCharge() {
		return detailCharge;
	}

	public void setDetailCharge(Double detailCharge) {
	...
	public String toString() {
		return "SpaceVO [spaceId=" + spaceId + ", memberId=" + memberId + ", empId=" + empId + ", spaceAddress="
				...
				+ ", spaceStatusComm=" + spaceStatusComm + ", avgComment=" + avgComment + ", detailCharge="
				+ detailCharge + "]";
	}
