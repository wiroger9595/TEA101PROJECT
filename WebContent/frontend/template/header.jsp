...
<head>
	...
	<link href="${pageContext.request.contextPath}/frontend/css/vendors.css" rel="stylesheet">
...
<body class="datepicker_mobile_full"><!-- Remove this class to disable datepicker full on mobile -->
	...
	<header class="header menu_fixed">
		...
		<div id="logo">
			<a href="index.html">
				<img src="${pageContext.request.contextPath}/frontend/img/pins/BigZooLogo.jpg" width="150" height="36" alt="" class="logo_normal">
				<img src="${pageContext.request.contextPath}/frontend/img/pins/BigZooLogo.jpg" width="150" height="36" alt="" class="logo_sticky">
			</a>
		</div>
		<ul id="top_menu">
